...
class Tile(base):
    ...
    mid = Column('map_id', Integer, ForeignKey('maps.map_id'), nullable=False)
    ...
    def __init__(self, tileID=None, mapID=None, numSides=None, coordinates=None, diameter=None, centerPoint=None,
        ...
        self.mid = mapID
        self.sides = numSides
        self.v1 = MapPoint(coordinates[0]).latlon_str
        self.v2 = MapPoint(coordinates[1]).latlon_str
        self.v3 = MapPoint(coordinates[2]).latlon_str
        self.v4 = MapPoint(coordinates[3]).latlon_str
        self.v5 = MapPoint(coordinates[4]).latlon_str
        self.v6 = MapPoint(coordinates[5]).latlon_str
        self.dm = diameter
